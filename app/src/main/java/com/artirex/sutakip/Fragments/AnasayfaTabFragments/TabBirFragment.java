 ...
 */
public class TabBirFragment extends Fragment {

     View view;
     RecyclerView recyclerview_alinanSiparisler;
    ...
    public TabBirFragment() {

    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_tab_bir, container, false);
    ...
    private void ViewComponentInitialize()
    {
       tv_veriBulunamadi = view.findViewById(R.id.tv_veriBulunamadi);
        recyclerview_alinanSiparisler = view.findViewById(R.id.recyclerview_alinanSiparisler);
        linearLayoutManager = new LinearLayoutManager(getContext());
        gridLayoutManager = new GridLayoutManager(getContext(),3);
        recyclerview_alinanSiparisler.setLayoutManager(linearLayoutManager);
            ...
            public void onResponse(Call<List<SiparisGet>> call, Response<List<SiparisGet>> response) {
                ...
                if(response.isSuccessful()) {
                    ...
                    }else
                    {
                        ...
                        recyclerview_alinanSiparisler.setAdapter(siparisAdapter);
                    }
