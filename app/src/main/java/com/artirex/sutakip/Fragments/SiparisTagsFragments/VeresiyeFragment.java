...
public class VeresiyeFragment extends Fragment {

    private View view;
    private RecyclerView recyclerview_veresiye;
    ...
    private SwipeRefreshLayout swipelayout_veresiye;
    private ChangeFragments changeFragments;


    public VeresiyeFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = inflater.inflate(R.layout.fragment_veresiye, container, false);

        Initialize();
        setHasOptionsMenu(true);

        getOrdersListPayment(4,0,"","");
    ...
    private void Initialize()
    {
        ...
        swipelayout_veresiye = view.findViewById(R.id.swipelayout_veresiye);

        recyclerview_veresiye = view.findViewById(R.id.recyclerview_veresiye);
        linearLayoutManager = new LinearLayoutManager(getContext());
        gridLayoutManager = new GridLayoutManager(getContext(),3);
        recyclerview_veresiye.setLayoutManager(linearLayoutManager);
        ...
        swipelayout_veresiye.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {

                getOrdersListPayment(4,0,"","");
                swipelayout_veresiye.setRefreshing(false);
            }
        });
            ...
            public void onResponse(Call<List<SiparisGet>> call, Response<List<SiparisGet>> response) {
                if(response.isSuccessful()) {
                    ...
                    }else
                    {
                        ...
                        recyclerview_veresiye.setAdapter(siparisAdapter);
                    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (itemId)
        {
            case R.id.menu_siparis_birhaftalik:
                getOrdersListPayment(4,1,"","");
                return true;
            case R.id.menu_siparis_ikihaftalik:
                getOrdersListPayment(4,2,"","");
                return true;
            case R.id.menu_siparis_biraylik:
                getOrdersListPayment(4,3,"","");
                return true;
